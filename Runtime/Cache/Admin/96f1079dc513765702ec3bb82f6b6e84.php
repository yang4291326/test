    ...
    <div class="tw-list-wrap">
        ...
        <form class="ids">
            <table class="tw-table tw-table-list tw-table-fixed">
                ...
                <!-- S=详细信息 -->	
                <tbody>
                    <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr <?php if(($type == 0) OR ($type == 2)): if($vo["is_default"] == 0): ?>style="color:red"<?php endif; endif; ?>></tr>
