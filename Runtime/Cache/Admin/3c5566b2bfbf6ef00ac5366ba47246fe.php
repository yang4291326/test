...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/furnitureshop/Application/Admin/Static/css/login.css" media="all">
   	<link rel="stylesheet" type="text/css" href="/furnitureshop/Application/Admin/Static/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
...
<body id="login-page">
        ...
        <div class="login-body">
            <div class="login-main pr">
                <form action="<?php echo U('doLogin');?>" method="post" class="login-form">
                    <h3 class="welcome" style="margin-left: -40px"><i class="login-logo"></i><?php echo C('WEB_SITE_TITLE');?></h3>
    ...
    <script type="text/javascript" src="/furnitureshop/Public/assets/js/hex_sha1.js"></script>
