...
<div class="tw-layout">
	...
	<?php if(!empty($prompt_tips)): ?><div class="tw_list_tips">
		 ...
		 <div class="tw-list-top">
	      	  ...
	      	  <form action="/index.php/Admin/Config/index" method="post" id='frmSearch'>
	...
	<div class="tw-list-wrap">
		<table class="tw-table tw-table-list tw-table-fixed">
			...
			<tbody>
				<?php if(!empty($list)): if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$config): $mod = ($k % 2 );++$k;?><tr>
