...
<body>
	...
	<div class="tw-layout">
    	...
    	<div class="tw-list-wrap tw-edit-wrap">
    	    <form action="/index.php/Admin/Goods/details/id/320" method="POST" class="form-horizontal ajaxForm">
	...
	<script type="text/javascript" charset="utf-8">
	    ...
	    function addDetail(){
            var newRow = "<tr>"
                       ...
                       + "<td>"
                       + "<div class='fl'>"
                       + "<div class='details-name'><input type='text' name='detail[name]["+ m +"]' class='text input-large color-text' placeholder='输入图片名称'/> <input class='btn btn-default btn-xs' type='button' value='删除详情' onclick='delDetailLine(this, "+ m +")'/></div>"
            ...
            ajaxUpload('#btnUpload'+ m +'', $('#img'+ m +''), 'Temp', m, true, 'GoodsDetail');
            m++;
        }
