...
<body>
    ...
    <div class="tw-layout">        
        <!-- S=文章管理 -->
        <div class="tw-list-hd"> 前台日志模块管理</div>
        ...
        <div class="tw-list-top">
            ...
            <div class="tw-tool-bar">
                ...
                <a class="tw-tool-btn-del" onclick="javascript:recycle('chkbId', '确认删除?! 删除后此前台日志模块将不在此地显示!')">
    ...
    <div class="tw-list-wrap">
        ...
        <form class="ids">
            <table class="tw-table tw-table-list tw-table-fixed">
                ...
                <thead>
                    <tr>
                        <th width="60" class="row-selected">
                            <input class="checkbox check-all" type="checkbox">
                        </th>
                        <th width="30">序号</th>
                        <th width="40%">前台日志模块名称</th>
                        <th width="50">排序</th>
                        <th width="200">操作</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    <?php if(!empty($data)): if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                ...
                                <td>
                                    ...
                                    <a class="tw-tool-btn-del" onclick="javascript:recycle(<?php echo ($vo['id']); ?>, '确认删除?! 删除后此前台日志模块将不在此地显示!')"><i class="tw-icon-minus-circle"></i> 删除
                                </td>
