...
<body>
    ...
    <div class="tw-layout">
        ...
        <div class="tw-list-wrap tw-edit-wrap">
            <form action="/index.php/Admin/GoodsImport/importexecl" enctype="multipart/form-data" method="POST" class="form-horizontal">
                <table>
                    <tr height="50px">
                        <th>选择Excel表:</th>
                        <td colspan='3'>
                            <input class="btn btn-default btn-layout_pathxs" type="file" name="importtable"/>
                        </td>
                    </tr>
                    <div class="tw-tool-bar-bot">
                        <button type="submit" class="tw-act-btn-confirm">导入</button>
