...
class AllianceMerchantDetailModel extends Model{    
    protected $insertFields = array('name', 'position_x', 'position_y', 'add_time', 'address', 'phone', 'photo_path', 'recommend', 'others', 'map_id');
    protected $updateFields = array('id', 'name', 'position_x', 'position_y', 'add_time', 'address', 'phone', 'photo_path', 'recommend', 'others', 'map_id');
